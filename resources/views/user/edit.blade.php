...
@section('content')
    <?php 
        ...
        $districts = \App\District::where('city_id', '=', $city_id)->where('active', '=', 1)->pluck('name', 'id');
        $towns = \App\Town::where('district_id', '=', $district_id)->where('active', '=', 1)->pluck('name', 'id');
    ?>
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('city_id') ? 'has-error' : ''}}">
                            ...
                            <div class="col-md-6">
                                {!! Form::select('city_id', $cities, $city_id, array('class' => 'form-control', 'id' => 'city')) !!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('district_id') ? 'has-error' : ''}}">
                            {!! Form::label('district_id', 'District', ['class' => 'col-md-4 control-label']) !!}
                            <div class="col-md-6">
                                {!! Form::select('district_id', $districts, $district_id, array('class' => 'form-control', 'id' => 'district')) !!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('town') ? 'has-error' : ''}}">
                            ...
                            <div class="col-md-6">
                                {!! Form::select('town_id', $towns, $town_id, array('class' => 'form-control', 'id' => 'town')) !!}
                                {!! $errors->first('town_id', '<p class="help-block">:message</p>') !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            {!! Form::label('map', 'Map', ['class' => 'col-md-2 control-label']) !!}
                            <div class="col-sm-10">
