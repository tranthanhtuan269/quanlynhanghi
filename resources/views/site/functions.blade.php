...
<div class="row">
	<div class="col-md-12">
		<div class="content-box-header">
			<div class="panel-title">Hướng dẫn sử dụng phần cập nhật</div>
			</div>
			<div class="content-box-large box-with-header">
				<div class="row one-box" style="width: 50%; float: left;">
					<div class="col-md-12"><h4>20/11/2017</h4></div>
					<div class="col-md-12 description" style="font-size: 13px;">Sửa lỗi khi mạng quá chậm, có thể nhấn nhiều lần vào nút đặt phòng gây sai dữ liệu.</div>
